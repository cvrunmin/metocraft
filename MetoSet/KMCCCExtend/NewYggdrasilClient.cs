...
namespace KMCCC.Modules.Yggdrasil
{
    ...
    ///     Yggdrasil(正版验证)客户端
    /// </summary>
    public class DebuggableYggdrasilClient
    {
        ...
        public DebuggableYggdrasilClient(string authServer = null) : this(authServer, Guid.NewGuid())
        {
        }

        public DebuggableYggdrasilClient(Guid clientToken) : this(null, clientToken)
        {
        }

        public DebuggableYggdrasilClient(string authServer, Guid clientToken)
        {
