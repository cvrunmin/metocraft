...
namespace KMCCC.Authentication
{
    ...
    ///     正版验证器（直接登陆）
    /// </summary>
    public class YggdrasilDebuggableLogin : IAuthenticator
    {
        /// <summary>
        ///     新建正版验证器
        /// </summary>
        ...
        public YggdrasilDebuggableLogin(string email, string password, bool twitchEnabled, Guid clientToken, string authServer = null)
        {
            Email = email;
            Password = password;
        ...
        /// <param name="twitchEnabled">是否启用Twitch</param>
        /// <param name="authServer">验证服务器</param>
        public YggdrasilDebuggableLogin(string email, string password, bool twitchEnabled, string authServer = null)
    ...
    ///     正版验证器（直接登陆）
    /// </summary>
    public class YggdrasilDebuggableRefresh : IAuthenticator
    {
        /// <summary>
        ///     新建正版验证器
        /// </summary>
        ...
        /// <param name="twitchEnabled">是否启用Twitch</param>
        /// <param name="clientToken">clientToken</param>
        public YggdrasilDebuggableRefresh(Guid accessToken, bool twitchEnabled, Guid clientToken, string authServer = null)
        {
        ...
        /// <param name="accessToken">合法的Token</param>
        /// <param name="twitchEnabled">是否启用Twitch</param>
        public YggdrasilDebuggableRefresh(Guid accessToken, bool twitchEnabled, string authServer = null)
